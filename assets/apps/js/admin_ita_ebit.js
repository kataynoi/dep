$(document).ready(function () {
  var dataTable = $("#table_data").DataTable({
    ...
    pageLength: 50,
    ajax: {
      url: site_url + "/admin_ita_ebit/fetch_admin_ita_ebit",
      data: {
...
crud.ajax = {
  del_data: function (id, cb) {
    var url = "/admin_ita_ebit/del_admin_ita_ebit",
      params = {
        id: id,
      };
  ...
  save: function (items, cb) {
    var url = "/admin_ita_ebit/save_admin_ita_ebit",
      params = {
        items: items,
      };
  ...
  get_update: function (id, cb) {
    var url = "/admin_ita_ebit/get_admin_ita_ebit",
      params = {
        id: id,
      };
...
crud.set_after_update = function (items, row_id) {
  ...
  row_id.find("td:eq(2)").html(items.ita_index);
...
crud.set_update = function (data, row_id) {
  ...
  $("#ita_index").val(data.rows["ita_index"]);
...
$("#btn_save").on("click", function (e) {
  ...
  items.id = $("#id").val();
  items.name = $("#name").val();
  items.ita_index = $("#ita_index").val();
  items.n_year = $("#n_year2").val();
