 ...
 */
class Admin_authority_model extends CI_Model
{
    var $table = "authority";
    ...
    /* End Datatable*/
    public function del_admin_authority($id)
    {
        $rs = $this->db
            ->where('id', $id)
            ->delete('authority');
    ...
    public function save_admin_authority($data)
    {
    ...
    public function update_admin_authority($data)
    {
        $rs = $this->db
            ->set("id", $data["id"])
            ->set("name", $data["name"])
    ...
    public function get_admin_authority($id)
    {
        $rs = $this->db
            ->where('id', $id)
            ->get("authority")
