...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ดัชนี ITA
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name">ชื่อดัชนี</label>
                    <input type="text" class="form-control" id="name" placeholder="ชื่อดัชนี" value=""></div>
            </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_ita_index.js" charset="utf-8"></script>
